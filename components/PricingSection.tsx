...
const plans = [
  {
    ...
    features: [
      ...
      { text: "Hosting 2 GB + SSL", included: true },
      { text: "Tombol WhatsApp & kontak", included: true },
      { text: "Katalog produk online", included: false },
      //   { text: "Integrasi pembayaran", included: false },
      //   { text: "Multi-admin & tim", included: false },
    ],
  },
  {
    id: "bisnis",
    ...
    features: [
      ...
      { text: "Hingga 10 halaman website", included: true },
      { text: "Katalog produk (maks. 100)", included: true },
      { text: "Integrasi Midtrans / Xendit", included: true },
      { text: "Email bisnis + analitik", included: true },
      //   { text: "SEO tools dasar", included: true },
      //   { text: "Multi-admin & tim", included: false },
    ],
  },
  {
    ...
    features: [
      ...
      { text: "Halaman & produk unlimited", included: true },
      { text: "Hingga 5 admin + role", included: true },
      { text: "Hosting 50 GB + CDN global", included: true },
      { text: "SEO pro + Google Ads pixel", included: true },
      //   { text: "Sync Tokopedia / Shopee", included: true },
